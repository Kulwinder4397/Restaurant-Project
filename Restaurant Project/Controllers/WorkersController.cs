...
namespace Restaurant_Project.Controllers
{
    ...
    {
        private readonly Restaurant_ProjectContext _context;
        ...
        {
            var restaurant_ProjectContext = _context.Worker.Include(w => w.Restaurant_ID);
            return View(await restaurant_ProjectContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["RestaurantID"] = new SelectList(_context.Restaurant, "RestaurantID", "RestaurantName", worker.RestaurantID);
            return View(worker);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WorkerID,WorkerName,StartDate,ContactNumber,EmailId,RestaurantName")] Worker worker)
        {

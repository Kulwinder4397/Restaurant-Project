...
namespace Restaurant_Project.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public RestaurantsController(Restaurant_ProjectContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RestaurantID,RestaurantName,RestaurantBranch,RestaurantOpeningDate,RestaurantAddress")] Restaurant restaurant)
        {
